...
void Player::spawn(IntRect arena, Vector2f resolution, int tileSize)
{
	...
	m_Arena.position.x = arena.position.x; //m_Arena.left = arena.left;
	m_Arena.size.x = arena.size.x; //	m_Arena.width = arena.width;
	m_Arena.position.y = arena.position.y; //m_Arena.top = arena.top;
	m_Arena.size.y = arena.size.y; //m_Arena.height = arena.height;
